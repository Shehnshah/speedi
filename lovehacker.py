...
jalan("\033[1;96m╱╱╱╱┃┃")
jalan("\033[1;96m╱╱╱╱╰╯")
jalan('\033[1;93m              Welcome to Black tiger')
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:MEER SHENSHAH
	    time.sleep(2)
            loop = 'false'
        else:
...
def pilih_super():
	...
	print "  \033[1;93m«---•◈•---Developed By MEER-SHENSHAH--•◈•---»" #Dev:Black-tiger
...
•\033[1;93m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;96m .... Dangerous Mafia....... \033[1;93m :
•\033[1;93m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                WhatsApp Num
              \033[1;96m ME Nh BATAONGA🙈🙄🙄""
